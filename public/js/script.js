...
function sendCountryName(country){
    socket.send(country);
}
...
function nextBirth(){
    ...
    document.getElementById('displayBornIn').innerHTML = "This is you if you were born in " + country;
...
function hide(){
    let element = document.getElementById("hideORshow");
...
function displayURL(){
    if (localStorage.getItem('URL') != undefined){
        document.getElementById('displayURL').innerHTML = "Open URL on new tab: " + localStorage.getItem('URL');
    }
    else{
        document.getElementById('displayURL').innerHTML = "Error, image failed to load";
    }
}